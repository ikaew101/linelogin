...
import ModalSuccess, { ItemSuccess } from "./ModalSuccess";
import { FaCheckCircle } from "react-icons/fa";

export default function TableSetpoint() {
  ...
  const inputClasses =
    "border text-sm border-gray-300 rounded-lg h-[2.5em] self-end py-1.5 px-2 w-full max-w-[88px] outline-0 disabled:bg-gray-200 disabled:opacity-70";
  return (
    <div
      className={`bg-white ${
        saving != "JPEG" ? "shadow" : ""
    ...
    >
      <div id="tableSetpoint" className="p-3 px-4">
                    ...
                    if (
                      ...
                      return (
                        ...
                        >
                          ...
                          <td>BEMSexpress</td>
                          <td>
                            <input type="number" className={cn(inputClasses)} />
                          </td>
                          <td>
                            <input type="number" className={cn(inputClasses)} />
                          </td>
      ...
      {isModalSuccess && (
        <ModalSuccess onClose={() => handleCloseModal()}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 ">
            <ItemSuccess title="min" text="0" />
            <ItemSuccess title="minTarget" text="0" />
            <ItemSuccess title="max" text="0" />
            <ItemSuccess title="maxTarget" text="0" />
          </div>
        </ModalSuccess>
      )}
    </div>
